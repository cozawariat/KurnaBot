...
say.export = function(text, voice, speed, filename, callback) {
  ...
  if (process.platform === 'darwin') {
    ...
    //pipedData = text;
    commands = [ 'Add-Type -AssemblyName System.speech; $speak = New-Object System.Speech.Synthesis.SpeechSynthesizer; $speak.SelectVoice("Microsoft Paulina Desktop"); $speak.SetOutputToWaveFile("'+ filename +'"); $speak.Speak("'+text+'"); $speak.Dispose(); $speak = $null' ];
